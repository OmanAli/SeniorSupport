                        ...
                        <div class="d-flex align-items-end row">
                            <div class="col-12">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <h5 class="card-title text-primary">About Page Offer Section</h5>
                                        </div>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-header">
                                                            <h5 class="modal-title">Update Offer Section</h5>
                                                        ...
                                                        <div class="modal-body" style="text-align: justify">
                                                            ...
                                                            <form method="post"
                                                                action="{{ route('AboutUpdateOfferSection') }}"
                                                                enctype="multipart/form-data">
                                                                @csrf
                                                                <div class="mb-3">
                                                                    <label class="form-label"
                                                                        for="basic-default-fullname">Offer
                                                                        Order</label><span style="color: red">*</span>
                                                                    <select name="offer_order" class="form-control"
                                                                        id="" required>
                                                                ...
                                                                <div class="mb-3">
                                                                    <label class="form-label"
                                                                        for="basic-default-fullname">Offer
                                                                        Title</label><span style="color: red">*</span>
                                                                    <input type="offer_title" class="form-control"
                                                                        value="{{ old('offer_title') ?? '' }}"
                                                                        name="offer_title" required />
                                                                </div>
                                                                <div class="mb-3">
                                                                    <label class="form-label"
                                                                        for="basic-default-company">Offer
                                                                        Description</label><span style="color: red">*</span>
                                                                    <input type="text" class="form-control"
                                                                        name="offer_description"
                                                                        value="{{ old('offer_description') ?? '' }}"
                                                                        required />
                                                                </div>
                                                                <div class="mb-3">
                                                                    <label class="form-label"
                                                                        for="basic-default-company">Offer Icon</label><span
                                                                        style="color: red">*</span><span
                                                                        style="color: red;font-size: 10px;">60 × 60
                                                                        px</span>
                                                                    <input type="file" class="form-control"
                                                                        name="offer_icon" accept="image/webp" required />
                                                                </div>
                                            ...
                                            @foreach ($data as $key => $item)
                                                <tr>
                                                    ...
                                                    <td style="text-align: justify">
                                                        <img src="{{ asset('offer/icons/' . $item->icon) }}" alt="Menu Icon"
                                                            width="60" height="60">
                                                    </td>
                                                    <td style="text-align: justify">
                                                        <form action="{{ route('AboutDeleteOfferSection', $item->id) }}"
