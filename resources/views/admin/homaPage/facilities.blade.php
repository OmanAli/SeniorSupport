                        ...
                        <div class="d-flex align-items-end row">
                            <div class="col-12">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <h5 class="card-title text-primary">Facilities Section</h5>
                                        </div>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-header">
                                                            <h5 class="modal-title">Update Facilities Section</h5>
                                                        ...
                                                        <div class="modal-body" style="text-align: justify">
                                                            ...
                                                            <form method="post"
                                                                action="{{ route('HomePageUpdatePlacmentSection') }}"
                                            ...
                                            <div class="modal fade" id="updateDataImageModal" tabindex="-1"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-header">
                                                            <h5 class="modal-title">Update Text</h5>
                                                            <button type="button" class="btn-close"
                                                                data-bs-dismiss="modal"></button>
                                                        </div>
                                                        ...
                                                        <div class="modal-body" style="text-align: justify">
                                                            <form method="post"
                                                                action="{{ route('HomePageUpdatePlacmentSectionText') }}"
                                                                enctype="multipart/form-data">
                                                                @csrf
                                                                <div class="mb-3">
                                                                    <label class="form-label"
                                                                        for="basic-default-company">Text</label><span
                                                                        style="color: red">*</span>
                                                                    <textarea name="text" id="" cols="30" rows="5" class="form-control" required>{{ $text->text ?? '' }}</textarea>
                                                                </div>
                            ...
                            <div class="col-12">
                                <div class="card-body">
                                    <table class="table table-striped table-hover" id="myTable">
                                        <thead>
                                            <tr>
                                                <th style="text-align: justify">Facility Heading</th>
                                                <th style="text-align: justify">Facility Description</th>
                                                <th style="text-align: justify">Facility Image</th>
                                            ...
                                            @foreach ($data as $key => $item)
                                                <tr>
                                                    ...
                                                    <td style="text-align: justify">
                                                        <img src="{{ asset('facilitis/picture/' . $item->image) }}"
                                                            alt="Menu Icon" width="60" height="60">
                                                    </td>
                                                    <td style="text-align: justify">
                                                        <form
                                                            action="{{ route('HomePageDeletePlacmentSection', $item->id) }}"
