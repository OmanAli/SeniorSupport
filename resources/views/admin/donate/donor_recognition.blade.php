                ...
                <div class="col-12 mb-4 order-0">
                                ...
                                <div class="col-12">
                                    <table class="table table-sm table-bordered mb-0">
                                        <tr>
                                            ...
                                            <td>{{ $texts->section_heading ?? 'Donor' }} <span class="text-purple fw-bold">{{ $texts->section_highlight ?? 'Recognition' }}</span></td>
                                        </tr>
                                        <tr>
                                            <td><strong>Description:</strong></td>
                                            <td>{{ Str::limit($texts->section_description ?? 'We deeply value every contribution...', 100) }}</td>
                                        </tr>
                                        <tr>
                                            <td><strong>Bottom Text:</strong></td>
                                            <td>{{ Str::limit($texts->bottom_text ?? 'Our donors are true partners...', 100) }}</td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="post" action="{{ route('DonateUpdateDonorRecognitionText') }}">
                                        @csrf
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-6">
                                                ...
                                                <input type="text" class="form-control" name="section_heading" 
                                                    value="{{ $texts->section_heading ?? 'Donor' }}" required />
                                            </div>
                                            <div class="col-6">
                                                ...
                                                <input type="text" class="form-control" name="section_highlight" 
                                                    value="{{ $texts->section_highlight ?? 'Recognition' }}" required />
                                            </div>
                                        </div>

                                        <div class="mb-3">
                                            <label class="form-label">Description <span class="text-danger">*</span></label>
                                            <textarea class="form-control" name="section_description" rows="3" required>{{ $texts->section_description ?? 'We deeply value every contribution. Every donor has the power to choose how they wish to be acknowledged.' }}</textarea>
                                        </div>

                                        <div class="mb-3">
                                            <label class="form-label">Bottom Text <span class="text-danger">*</span></label>
                                            <textarea class="form-control" name="bottom_text" rows="2" required>{{ $texts->bottom_text ?? 'Our donors are true partners in helping seniors find safe and appropriate care environments.' }}</textarea>
                                        </div>
                        ...
                        <div class="d-flex align-items-end row">
                            <div class="col-12">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <h5 class="card-title text-primary">Cards (Select Order 1-3)</h5>
                                        </div>
                                        <div class="col-md-6 text-end">
                    ...
                    <div class="modal fade" id="addCardModal" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title">Add Card (Select Order 1-3)</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                </div>
                                <div class="modal-body">
                                    <form method="post" action="{{ route('DonateAddDonorRecognitionCard') }}" enctype="multipart/form-data">
                                        @csrf
                                        
                                        <div class="mb-3">
                                            <label class="form-label">Select Order (1-3) <span class="text-danger">*</span></label>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="title" placeholder="e.g. Remain Anonymous" required />
                                        </div>
                                ...
                                <tbody>
                                    @foreach ($cards as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <img src="{{ asset('assets/images/donate/recognitionicons/' . $item->icon) }}" 
                                                     alt="Icon" width="50" height="50">
                                            </td>
                                            <td>
                                                <form action="{{ route('DonateDeleteDonorRecognitionCard', $item->id) }}" 
