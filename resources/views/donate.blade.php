...
@section('content')
    ...
    {{-- hero section --}}
    <section
        class="donate-hero-section position-relative d-flex align-items-center justify-content-center py-5 py-lg-6 px-3">
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-8 text-center text-white">
                    ...
                    <p class="mb-4 opacity-75">
                        Your generosity fuels our mission and helps families navigate one of the most important decisions of
                        their lives. Every contribution—no matter the size—supports safe, compassionate placement solutions
                        for seniors in need.
                    </p>
                    <a href="#donate-form"
                        class="btn btn-purple btn-lg rounded-pill px-5 py-3 d-inline-flex align-items-center gap-2 text-decoration-none">
                        Donate Now
        ...
        <div class="container">
            <div class="row justify-content-center mb-5">
                <div class="col-12 col-lg-8 text-center">
                    ...
                    <p class="text-muted fs-5">Your generosity today helps a senior find the right place to call home
                        tomorrow.</p>
                </div>
            </div>
                        ...
                        <form action="{{ route('DonateSubmit') }}" method="POST">
                            ...
                            <div class="form-group-custom">
                                ...
                                <input type="text" name="name" class="form-input-custom"
                                    placeholder="Enter your name or organization" required>
                            </div>
                            ...
                            <div class="form-group-custom">
                                ...
                                <input type="tel" name="phone" class="form-input-custom"
                            ...
                            <div class="form-group-custom">
                                ...
                                <div class="amount-wrapper">
                                    ...
                                    <input type="number" name="amount" class="form-input-custom amount-input"
        ...
        <div class="container">
            ...
            <div class="row justify-content-center mb-5">
                <div class="col-12 col-lg-8 text-center">
                    ...
                    <p class="fs-5 text-secondary lh-lg">
                        At Senior Support Solutions, we believe every senior deserves dignity, safety, and the right care
                        environment. Your donation directly supports families searching for assisted living, memory care,
            ...
            <div class="row why-donate-row g-2 g-md-4">
                ...
                <div class="col-6 col-lg-3 d-flex">
                    ...
                    <div class="card w-100 border-0 shadow-sm rounded-4 p-3 text-center hover-shadow transition-all d-flex flex-column"
            ...
            <div class="row mt-5">
                <div class="col-12 col-lg-8 mx-auto text-center">
                    <p class="fs-5 fw-medium text-dark">
                        Your support is not just a gift — it is an investment in stability, security, and compassionate care
                        for seniors.
                    </p>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row g-4 g-md-3 impact-cards-row">
                ...
                <div class="col-6 col-lg-3 d-flex">
                    ...
                    <div
                        class="card w-100 border-0 shadow rounded-4 text-center p-3 p-md-4 bg-white d-flex flex-column justify-content-center impact-card">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-6 col-lg-5 card-spacing-wrapper">
                    <div class="card h-100 shadow-sm rounded-4 p-4 give-card-custom hover-shadow">
                        <div class="text-center mb-3">
                            <span
                                class="d-inline-flex align-items-center justify-content-center rounded-circle bg-purple text-white"
                ...
                <div class="col-md-6 col-lg-5 card-spacing-wrapper">
                    <div class="card h-100 shadow-sm rounded-4 p-4 give-card-custom hover-shadow">
                        ...
                        <p class="card-text card-text-dark text-secondary text-center small mb-0">
                            Become a sustaining partner. Recurring donations allow us to continue providing guidance and
                            placement services consistently and confidently.
                        </p>
                    </div>
                </div>
                    ...
                    <div class="card h-100 shadow-sm rounded-4 p-4 give-card-custom hover-shadow">
                        <div class="text-center mb-3">
                            <span
                                ...
                                <svg width="24" height="24" fill="white" viewBox="0 0 24 24">
                                    <path
                                        d="M12 2l-9 9h18l-9-9zm0 2.8l6.2 6.2H5.8L12 4.8zM19 13v7H5v-7h14zm-7 2H7v3h5v-3z" />
                                </svg>
                            </span>
                        </div>
                        <h4 class="h5 fw-bold text-center mb-2">Major Gifts</h4>
                        <p class="card-text card-text-dark text-secondary text-center small mb-0">
                            Interested in sponsoring community education initiatives or expanding placement services?
                            Contact us directly to discuss partnership opportunities.
                        </p>
                    </div>
                </div>
                    ...
                    <div class="card h-100 shadow-sm rounded-4 p-4 give-card-custom hover-shadow">
                        <div class="text-center mb-3">
                            <span
                                ...
                                <svg width="24" height="24" fill="white" viewBox="0 0 24 24">
                                    <path
                                        d="M16.5 13c-1.2 0-3.07.34-4.5 1-1.43-.67-3.3-1-4.5-1C5.38 13 2 14.5 2 16.5V19h20v-2.5c0-2-3.38-3.5-5.5-3.5zM12.5 17.5h-1v-1h1v1zm0-2.5c-1.67 0-5.5-1.17-5.5-3.5 0-1.5 1.67-2.5 3.5-2.5 1.33 0 2.5.67 3.5 1.67 1-1 2.17-1.67 3.5-1.67 1.83 0 3.5 1 3.5 2.5 0 2.33-3.83 3.5-5.5 3.5z" />
                                </svg>
                            </span>
                        </div>
                        ...
                        <p class="card-text card-text-dark text-secondary text-center small mb-0">
                            ...
                            Organizations and businesses can collaborate with Senior Support Solutions through sponsorships,
                            events, or matching gift programs.
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-5 mb-5 mb-lg-0">
                        ...
                        <p class="fs-5 text-secondary mb-4">
                            We are committed to financial transparency. Your donations are directly allocated toward making
                        ...
                        <div class="ps-lg-5">
                            ...
                            <div class="benefit-item shadow-sm">
                                ...
                                <div class="benefit-content">
                                    ...
                                    <p class="mb-0 text-secondary small">Consultations and coordination for the right care
                                        settings.</p>
                                </div>
                            </div>
                            ...
                            <div class="benefit-item shadow-sm">
                                ...
                                <div class="benefit-content">
                                    ...
                                    <p class="mb-0 text-secondary small">Comprehensive support services for families in
                                        transition.</p>
                                </div>
                            </div>
                            ...
                            <div class="benefit-item shadow-sm">
                                ...
                                <div class="benefit-content">
                                    ...
                                    <p class="mb-0 text-secondary small">Education and awareness initiatives for senior
                                        care.</p>
                                </div>
                            </div>
                            ...
                            <div class="benefit-item shadow-sm">
                                ...
                                <div class="benefit-content">
                                    ...
                                    <p class="mb-0 text-secondary small">Ensuring long-term sustainability and reliable
                                        service.</p>
                                </div>
                            </div>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center mb-5 g-4 gy-4 text-center">
                <div class="col-lg-8">
                    ...
                    <p class="fs-5 text-secondary">
                        We deeply value every contribution. Every donor has the power to choose how they wish to be
                        acknowledged.
                    </p>
                </div>
            </div>
                ...
                <div class="col-12 text-center">
                    <div class="partnership-footer-text">
                        <p class="fs-5 fw-medium text-dark mb-0">
                            ...
                            Our donors are <span class="text-purple fw-bold">true partners</span> in helping seniors find
                            safe and appropriate care environments.
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="donate-form-card">
                        ...
                        <div class="text-center mt-5">
                            ...
                            <div class="contact-card p-3" style="background: #fcfaff; border-radius: 15px;">
                                <p class="small fw-bold mb-2" style="color: #555;">For questions about donations,
                                    partnerships, or planned giving, please contact:</p>
                                <div class="d-flex flex-column gap-1">
                                    ...
                                    <!--</a>-->
                                    <a href="mailto:seniorsupportsolutions@gmail.com"
                                        class="text-purple text-decoration-none small fw-bold">
