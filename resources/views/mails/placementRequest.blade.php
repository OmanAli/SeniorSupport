...
<head>
    ...
    <title>New Placement Request</title>
    <style>
        ...
        <table class="main" role="presentation">
            ...
            <tr>
                <td class="content">
                    <p class="intro-text">
                        Hello, <br>
                        A new placement request has been submitted through your website. Below are the details provided
                        by the applicant:
                    </p>
                    ...
                    <table class="data-table">
                        ...
                        <tr>
                            <th>Senior's Age</th>
                            <td>{{ $data->senior_age }} years old</td>
                        </tr>
                        <tr>
                            <th>Care Type</th>
                            <td>{{ $data->care_type }}</td>
                        </tr>
                        <tr>
                            <th>Location</th>
                            <td>{{ $data->location }}</td>
